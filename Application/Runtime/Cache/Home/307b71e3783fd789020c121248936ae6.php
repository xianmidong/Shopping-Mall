...
<head>
    ...
    <script src="/furniture/Public/js/buynow/buynow.js"></script>
...
<div class="order_main">
    ...
    <div class="order_info">
        ...
        <div class="goods">
            ...
            <div class="order_box">
                <div style="width: 45%">
                    <span class="goodsimg"><img src="/furniture/Public/goodsimg/<?php echo ($img); ?>"/></span>
                    <span class="goodsname "><?php echo ($goodsname); ?></span>
                </div>
                <div style="width: 20%">￥<span class=""><?php echo ($goodsprice); ?></span></div>
                <div style="width: 12%"><span class=""><?php echo ($goodscount); ?></span></div>
                <div style="width: 20%">￥<span class=""><?php echo ($sum); ?></span></div>
                <!--<span class="catrid" style="display: none"><?php echo ($vo["cartid"]); ?></span>-->
            </div>

    </div>
    <div class="order_footer">
        <div class="count">总件数:<span><?php echo ($goodscount); ?></span></div>
        <div class="total">总金额(￥):<span><?php echo ($sum); ?></span></div>
